...
add_lockdown_pred <- function(data.df)
{
  ...
  data.df$lockdown <- factor(data.df$lockdown, levels = c("Before","1st Lockdown","New normal","Lockdown 2.0", 'Newer normal','Tier 3','Tier 4 part 1','X-mas bauble','Tier 4 part 2','Lockdown 3.0','Step 1 pt.1','Step 1 pt.2','Step 2','Step 3','Step 3.5','End of the Pandemic','prediction'))
  return(data.df)
}
